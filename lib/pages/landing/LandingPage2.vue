  ...
  <div class="bg-white dark:bg-slate-900">
    <div class="relative overflow-hidden">
      <main>
        ...
        <div class="relative bg-white dark:bg-slate-900 py-16 sm:py-24 lg:py-32">
                ...
                <div class="pt-6">
                  <div class="flow-root bg-gray-50 rounded-lg px-6 pb-8">
                    <div class="-mt-6">
                      <div>
                        <span
                          class="inline-flex items-center justify-center p-3 bg-gradient-to-r from-primary-500 to-indigo-600 rounded-md shadow-lg"
                        >
        ...
        <!-- Testimonial section -->
        <div
          class="pb-16 bg-gradient-to-r from-primary-500 to-indigo-600 lg:pb-0 lg:z-10 lg:relative"
        >
          <div class="lg:mx-auto lg:max-w-7xl lg:px-8 lg:grid lg:grid-cols-3 lg:gap-8">
            <div class="relative lg:-my-8">
              <div
                aria-hidden="true"
                class="absolute inset-x-0 top-0 h-1/2 bg-white dark:bg-slate-900 lg:hidden"
              ></div>
        ...
        <div class="relative bg-gray-900">
          <div class="relative h-56 bg-indigo-600 sm:h-72 md:absolute md:left-0 md:h-full md:w-1/2">
            ...
            <div
              aria-hidden="true"
              class="absolute inset-0 bg-gradient-to-r from-primary-500 to-indigo-600 mix-blend-multiply"
            ></div>
          </div>
          <div
            ...
            <div class="md:ml-auto md:w-1/2 md:pl-10">
              ...
              <div class="mt-8">
                <div class="inline-flex rounded-md shadow">
                  <a
                    href="#"
                    class="inline-flex items-center justify-center px-5 py-3 border border-transparent text-base font-medium rounded-md text-gray-900 bg-white dark:bg-slate-900 hover:bg-gray-50"
                  >
